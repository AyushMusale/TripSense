...
class TripcreationrepoImp extends Tripcreationrepo {
  ...
  @override
  Future<Trip> tripcreationfn(String date, String destination, {String mode = "Not Decided"}) async{
    ...
    return Trip(date: jsonRes.date,  destination: jsonRes.destination, mode: jsonRes.mode, id:  jsonRes.id , errormsg: jsonRes.errormsg);
  }
