...
class TripcreationrepoImp extends Tripcreationrepo {
  ...
  @override
  Future<Tripmodel> tripcreationfn(String date, String destination, {String mode = "Not Decided"}) async{
    ...
    return Tripmodel(date: jsonRes.date,  destination: jsonRes.destination, mode: jsonRes.mode, id:  jsonRes.id , errormsg: jsonRes.errormsg);
  }
